...

{
    ...
    protected $fillable = [
        ...
        'name', 'email', 'password','phone','role','address','otp','registered_by','is_active','is_verified','is_registered','device_token','registered_by','gender','DOB','profile', 'verify','wallet_balance', 'user_device_token', 'user_device_type', 'device_cart_id', 'dial_code', 'invite', 'is_invite', 'firebase_user_key'
