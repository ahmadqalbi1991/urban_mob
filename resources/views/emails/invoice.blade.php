                        ...
                        <tr>
                          <td style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top; text-align: left;">
                            <br> 
                              ...
                              Flat No. {{$data->address?$data->address->flat_no:"-"}}, {{$data->address?$data->address->building:"-"}}, 
                              <br>
                              {{$data->address?$data->address->locality:"-"}},
                              ...
                              <a style="text-decoration: underline; color:blue; font-weight: 700;" 
                              href="https://www.google.com/maps/search/?api=1&query={{$data->address?$data->address->latitude:0}},{{$data->address?$data->address->longitude:'0'}}"> Click here for location </a>
                              <br><br> 

                              @endif
                              <b>Creation Date : </b>{{$data?$data->updated_at:''}}<br>
                              <b>Service : </b>
                              ...
                              @if($data && $data->payment_moad=='Card')
                              <!-- <br> -->
                              <!-- <b>Payment Transaction ID : </b>
                                  @if(isset($data->paymentTranId))
                                      {{$data->paymentTranId}}
                                  @else
                                      {{$data->tabby_payment_response_id}}
                                  @endif
                              @endif -->
                          </td>
                        </tr>
...
<!--                         <tr>
                        ...
                        <tr>
                          <td style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top; text-align: right;">
                            <small>Booking ID :</small> {{$data->id}}<br />
                            <small>Creation Date : {{ date('d F Y', strtotime($data->updated_at))}}</small>
                            <a href="{{ $data->payment_link }}" target=”_blank” style="background-color: #e8ac18; border: none; color: white; padding: 2px 13px; text-align: center; text-decoration: none; display: inline-block; font-size: 11px; margin: 4px 2px; cursor: pointer; margin-top: 50%; border-radius: 7px; box-shadow: 4px 4px 3px rgb(0 0 0 / 41%);">Pay This Invoice</a><br><small>(Kindly ignore if already paid.)</small>
                            <br>
                            <a href="https://play.google.com/store/apps/details?id=com.urbanmop" target="_blank">
                            <img src="https://www.urbanmop.com/web/assets/img/urbanmop-on-playstore.png" width="97px" height="30px" alt="logo" border="0" />
                            </a>
                            <br>
                            
                            <a href="https://apps.apple.com/in/app/urbanmop/id6474144613" target="_blank">
                            <img src="https://www.urbanmop.com/web/assets/img/urbanmop-on-appstore.png" width="97px" height="30px" alt="logo" border="0" />
                        	</a>
                ...
                <table width="480" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e;  line-height: 18px;  vertical-align: top; padding:10px 0;">{{$items->attribute_name}}</td>

                      <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e;  line-height: 18px;  vertical-align: top; padding:10px 0;">{{$items->attribute_item_name}}</td>
              ...
              <td>
                ...
                <table width="480" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                  <tbody>
                    ...
                    @if($data && count($data->card_addon))
                      <?php $addonAmt = $data->card_addon->sum('value'); ?>
                      <tr>
                        <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e; line-height: 22px; vertical-align: top; text-align:right; ">Addon</td>
                        <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e; line-height: 22px; vertical-align: top; text-align:right; white-space:nowrap;" width="80">
                          <small>AED {{$addonAmt}}</small>
                        </td>
                      </tr>
                      <?php $total += $addonAmt ?>
                    @endif
