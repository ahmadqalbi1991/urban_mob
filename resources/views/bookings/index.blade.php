                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center" id="action-buttons-booking">
                                                    ...
                                                    <a href="javascript:" onclick="payPayment({{$value}})" data-toggle="modal" data-target="#payPayment"><button type="button" class="btn btn-outline-info btn-ft btn-sm" title="Pay Payment" alt="Pay Payment"><i class="fa fa-money" aria-hidden="true"></i></button></a>
                                                    @endif
