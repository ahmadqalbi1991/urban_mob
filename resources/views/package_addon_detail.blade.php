            ...
            <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="breadcrumb-range-picker">
                            <h3 class="ml-1">Extra Order Detail</h3>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="media align-items-center mb-4">
                                        ...
                                        <div class="media-body">
                                            <h3 class="mb-0">{{$addon->vendor->name}}</h3>
                                            <p class="text-muted mb-0">Vendor</p>
                                        </div>
                                    </div>

                                    <h4>Address</h4>
                                    <p class="text-muted">{{$addon->vendor->address}}</p>
                                    <p class="text-muted">{{$addon->vendor->city}}</p>
                                    <ul class="card-profile__info">
                                        <li class="mb-1"><strong class="text-dark mr-4">Mobile</strong> <span>{{$addon->vendor->phone}}</span></li>
                                        <li class="mb-1"><strong class="text-dark mr-4">Email</strong> <span>{{$addon->vendor->email}}</span></li>
