                                ...
                                <div class="card-body">
                                    ...
                                    <div class="custom-tab-2">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-border table-hover table-sm" >
                                                ...
                                                <tbody>
                                                    ...
                                                    @if(!empty($service_completed))

                                                    @foreach($service_completed as $key=>$value)
                                        ...
                                        <div class="text-left float-left mt-1">
                                            ...
                                            <p>Displaying {{$service_completed->count()}} of {{ $service_completed->total() }} bookings.</p>

                                        </div>

                                        <div class="text-right float-right">{{ $service_completed->appends(request()->all())->links() }}</div>
