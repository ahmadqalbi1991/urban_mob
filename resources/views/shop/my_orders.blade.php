                        ...
                        <div class="card">
                            <div class="card-body">
                               ...
                               <div class="table-responsive">
                                ...
                                <a href="{{ route('order.delivered',['today' => 'No']) }}" onclick="return confirm('Are you sure to delivered all pending order')"><button type="button" class="btn btn-outline-success btn-ft">All Delivered</button></a>
                            </div>
                        </div>
                    </div>
                </div>
